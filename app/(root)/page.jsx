...
// Suppress fullPage.js v4 licenseKey console noise (non-commercial portfolio)
if (typeof window !== "undefined") {
  const _consoleError = console.error.bind(console);
  console.error = (...args) => {
    if (typeof args[0] === "string" && args[0].includes("fullPage")) return;
    _consoleError(...args);
  };
}
      ...
      <ReactFullpage
        render={({ state, fullpageApi }) => (
          <ReactFullpage.Wrapper>
              ...
              <div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
                ...
                >
                  ...
                  >
                    ...
                    TypeScript, PostgreSQL, MongoDB, and Supabase. Skilled in
                    frontend-backend integration, REST API development, AI
                    integrations, and cloud deployment on AWS.
                  </motion.p>
                  <motion.div
            ...
            <div className="section">
              <div className="relative md:h-screen w-screen gap-4 flex justify-center items-center flex-col overflow-hidden">
                ...
                <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
                  ...
                  <Hr />
                  <motion.p
                    className="title  text-xl mt-4 tracking-wider text-gray-900 dark:text-gray-100 leading-[1.7rem] mb-5"
                    initial={{ x: -100, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1 }}
                    transition={{
                      delay: 0.2,
            ...
            <div className="section">
              <div className="relative md:h-screen w-screen flex justify-center items-center overflow-hidden">
                {/* Mobile: normal flow. Desktop: absolute left-[10%] top-1/3 (matches About & Projects) */}
                <div className="z-10 w-full px-8 flex flex-col items-start md:absolute md:w-auto md:left-[10%] md:top-1/3 md:px-10">
                  <motion.h1
                    className="text-black dark:text-white text-4xl md:text-6xl font-bold mb-3"
                    initial={{ x: -100, opacity: 0 }}
