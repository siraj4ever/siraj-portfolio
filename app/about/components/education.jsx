...
import cuCampus1 from "@/public/image/cu-campus/entrance.jpg";
import cuCampus2 from "@/public/image/cu-campus/block.jpg";
import cuCampus3 from "@/public/image/cu-campus/library.jpg";

import lpuCampus1 from "@/public/image/lpu-campus/entrance.jpg";
import lpuCampus2 from "@/public/image/lpu-campus/block.jpg";
import lpuCampus3 from "@/public/image/lpu-campus/classroom.jpg";
      ...
      <section className="grid gap-8 md:gap-12">
        ...
        <div className="grid gap-8 md:gap-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="px-5">
              <div className="font-medium text-lg">2022 - 2026</div>
              <div>
