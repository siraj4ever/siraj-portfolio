    ...
    <>
      {project.category.includes(parseInt(activeCategory)) && (
        <Link href={"projects/" + project.slug} key={index}>
          <motion.div
            className="z-10 relative flex justify-center items-start flex-col mb-5 md:px-10 w-full h-auto bg-gray-400 dark:bg-gray-700 group/tes py-20 px-5 md:py-2 aspect-video "
            initial={{
              opacity: 0,
              x: -200,
            }}
          ...
          >
            ...
            />
            <div className="absolute top-0 left-0 bg-gray-600 dark:bg-gray-700 px-4 py-2">
            ...
            <div className="transition-all ease duration-500 opacity-100 content text-center group-hover/tes:opacity-0 z-10">
              <h1 className="text-3xl font-bold mb-3 text-black dark:text-white">{project.title}</h1>
