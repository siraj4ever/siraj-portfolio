...
// images
import ReactChat1 from "@/public/image/projects/web/pdvsa/pdvsa1.png";
import ReactChat2 from "@/public/image/projects/web/pdvsa/pdvsa2.png";
import ReactChat3 from "@/public/image/projects/web/pdvsa/pdvsa3.png";
    ...
    <>
      <main className="overflow-hidden">
        ...
        <div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
          ...
          <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-gray-100 dark:bg-gray-800 bg-opacity-50 dark:bg-opacity-70 md:bg-transparent md:dark:bg-transparent md:pt-0">
            ...
            <p className="title  text-xl mt-4 tracking-wider text-gray-900 dark:text-gray-100 leading-[1.7rem] mb-5">
              <span className="block">A list of projects I have completed</span>
              <span className="block bg-transparent md:bg-gray-100 bg-opacity-50 dark:bg-opacity-50 xl:bg-transparent">
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              The PDVSA Project is a web-based application developed to support
              operational management in the oil and gas industry. The platform
              enables efficient management of fuel records, workforce data, and
              shift planning, while centralizing operational information in a
              single system. By improving data accuracy, transparency, and
              accessibility, the application helps supervisors and
              decision-makers monitor operations, optimize resources, and ensure
              smoother day-to-day activities across teams.
            </p>{" "}
            <div className="mt-3">
