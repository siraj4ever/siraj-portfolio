...
// images
import ReactChat1 from "@/public/image/projects/web/patientcampaign/pc1.png";
import ReactChat2 from "@/public/image/projects/web/patientcampaign/pc2.png";
import ReactChat3 from "@/public/image/projects/web/patientcampaign/pc3.png";
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              The Patient Campaign Project is a web-based application designed
              to enhance patient engagement through personalized campaigns. By
              prioritizing patient engagement, the system ensures better health
              outcomes and increased revenue streams, creating a win-win
              situation for both healthcare providers and patients
            </p>{" "}
            <div className="mt-3">
              <Button variation="primary">
                <Link href="projects/patientcampaign">More</Link>
              </Button>
              <Button variation="secondary">
                <a
                  href="https://www.patientcampaign.com/"
                  target="_blank"
