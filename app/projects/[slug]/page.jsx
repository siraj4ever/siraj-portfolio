      ...
      <div className="min-h-screen flex justify-center items-center">
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2  mt-10 md:mt-0">
          <div className="min-h-screen sm:min-h-0 flex justify-center items-start flex-col mb-5 space-y-10 mx-auto">
            <div>
              <h2 className="uppercase font-normal text-lg tracking-[8px] text-neutral-400 dark:text-neutral-500">
                Project
              </h2>
              <h1 className="text-4xl font-medium text-neutral-900 dark:text-white">
                {data.title}
              </h1>
            </div>
            <div>
              ...
              <p className="text-2xl font-normal text-neutral-900 dark:text-white">
                {data.tech.join(", ")}
              </p>
            </div>
            <div>
          ...
          <div className="flex justify-start items-start flex-col mb-5 ">
            ...
            {data.desc.map((desc, index) => (
              <p
                key={index}
                className="text-xl text-justify tracking-wide font-normal text-gray-500 dark:text-gray-300 mb-5"
              >
                {desc}
              </p>
            ))}
